                ...
                <div className="space-y-4">
                  ...
                  <div className="block">
                    ...
                    <Select
                      ...
                      className="w-full rounded-xl border border-gray-200/70 bg-white/60 px-3 py-2.5 text-sm text-gray-700 outline-none opacity-50 cursor-not-allowed dark:border-white/[0.08] dark:bg-white/[0.03] dark:text-gray-200"
                    />
                  </div>
